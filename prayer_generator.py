#!/usr/bin/env python3
"""
Adeptus Mechanicus Prayer Generator using Gemini API
...
MODEL = "gemini-2.5-flash"  # Best free tier option

# Output Configuration
OUTPUT_DIR = Path("mechanicus_prayers_dataset")
BATCH_SIZE = 10  # Prayers per API call (safe for 8K token limit)
TARGET_TOTAL = 1000  # Total prayers to generate

# Generation Parameters
RATE_LIMIT_DELAY = 4.5  # Seconds between requests (15 RPM = 4s, add buffer)
...
"""
    ...
    try:
        ...
        # Parse JSON
        prayers = parse_gemini_response(response_text)
...
def main():
    ...
    print(f"🔧 Mechanicus Prayer Generator")
    print(f"━" * 60)
    ...
    print(f"  3. Train with nanoGPT (should take ~2-6 hours on RTX 4070)")
